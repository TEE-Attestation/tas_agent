...
key_id = "771e76e7924348899ef751d0754c9060dd805928d03043f29a065275f4f883c8"
...
| `-c`, `--config <FILE>` | Path to config file (default: `/etc/tas_agent/config.toml`) |
| `--server-uri <URI>` | TAS REST service URI |
| `--api-key <FILE>` | Path to API key file |
| `--key-id <ID>` | Key ID to request from TAS |
| `--cert-path <FILE>` | Path to CA root certificate (HTTPS only) |
| `--max-retries <N>` | Max retry attempts (default: 3) |
| `--retry-min-backoff-secs <S>` | Min backoff between retries (default: 1) |
| `--retry-max-backoff-secs <S>` | Max backoff between retries (default: 30) |
